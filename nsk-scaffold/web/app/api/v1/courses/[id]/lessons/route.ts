...
import { createLessonSchema } from "@/lib/validators/academy";

interface Params {
  params: Promise<{ id: string }>;
}

// POST /api/v1/courses/{id}/lessons — aggiunge una lezione al corso.
// RLS "lessons_chef_write" impone che il chef sia il proprietario del corso.
