...
export function FinalCTA() {
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(160deg,#1B2C44 0%,#0B1220 65%,#000000 100%)" }}
    >
      <div className="mx-auto max-w-[620px] text-center">
        ...
        <form onSubmit={handleSubmit} className="flex flex-wrap justify-center gap-3">
          <input
            ...
            className="min-w-[240px] rounded-nsk border border-ivory/10 bg-[#22344F] px-[18px] py-[13px] font-body text-sm font-medium text-ivory placeholder:text-ivory/50 focus:border-teal focus:outline focus:outline-2 focus:outline-teal"
          />
          <button
            type="submit"
